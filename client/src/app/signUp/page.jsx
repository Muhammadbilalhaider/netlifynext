...
const BASE_URL = process.env.BASE_URL || "http://localhost:8087/api_v1";
...
const CreateAccount = () => {
    ...
    const [formData, setFormData] = useState({
        name: "", email: "", phone: "", password: "", OTP: "", cardNumber: ""
    });
    ...
    const handleSavePreferences = async () => {
        ...
        try {
            ...
            const response = await axios.put(
                `${BASE_URL}/user/addJobPreferences`,
    ...
    const handleJobTitle = () => {
        if (preferencesData.primaryJobTitles.trim() !== '') {
           ...
           setPreferencesData({primaryJobTitles:""})
        }
    };
    ...
    const hadleAddOTP = async () => {
        const response = await axios.put(`${BASE_URL}/auth/verify-otp`,
            {
                    ...
                    <div className='flex w-full flex-col justify-center items-center space-y-6'>
                        ...
                        <div className='flex flex-row  w-full space-x-3 mt-8'>
                            <input className='w-full flex py-2 p-2 border-2 border-[#247BAF] focus:outline-none focus:ring-1 focus:ring-[#247BAF] rounded-lg'
                                ...
                                name="primaryJobTitles"
                             
                                 onChange={handlepreferencesData}
                                 value={preferencesData.primaryJobTitles}
                                 />
                            ...
                            {jobLevels.map((value, index) => (
                                <div className='flex flex-col w-full items-start' key={index}>
                                    <div className='flex flex-row space-x-5'>
                                        <input className='w-5 h-5 border-2 border-[#247BAF] focus:outline-none focus:ring-1 focus:ring-[#247BAF] rounded-lg' 
                                        type='checkbox' 
                                        name='secondaryJobTitles' 
                                        value={value} 
                                        checked={preferencesData?.secondaryJobTitles?.includes(value) || false} onChange={handlepreferencesData} />
                    ...
                    <div className='flex w-full flex-col justify-center items-center space-y-4'>
                        ...
                        <div className='flex flex-row  w-full space-x-3 mt-8'>
                            <input className='w-full flex py-2 p-2 border-2 border-[#247BAF] focus:outline-none focus:ring-1 focus:ring-[#247BAF] rounded-lg'
                                ...
                                name='excludedJobTitleKeywords' 
                                value={preferencesData.excludedJobTitleKeywords || ""}
                                onChange={handlepreferencesData} />
                        ...
                        <span className='flex w-full flex-col justify-center items-center space-y-4'>
                            ...
                            <div className='flex w-full flex-col justify-center space-y-5'>
                                ...
                                <div className='flex flex-col w-full space-y-1'>
                                    ...
                                    type='email' 
                                    name="jobLocations" 
                                    value={preferencesData.jobLocations || ""}  
                                    onChange={handlepreferencesData} 
                                ...
                                <div className='flex w-full flex-col space-y-2'>
                                    ...
                                    <span className='flex flex-row space-x-2 items-center'>
                                        <input type='checkbox' className='w-4 h-4' name='workType'
                                            value='Remote'
                                            checked={(preferencesData.workType || []).includes("Remote")}
                                            onChange={handlepreferencesData} />
                                    ...
                                    <span className='flex flex-row space-x-2 items-center'>
                                        <input type='checkbox' className='w-4 h-4'
                                         name='workType'
                                            ...
                                            checked={preferencesData.workType?.includes('Hybrid/On-Location') || false} 
                                            onChange={handlepreferencesData} />
                    ...
                    <div className='flex w-full flex-col justify-center items-center space-y-4'>
                        <span className='flex flex-col w-full justify-center items-center space-y-4'>
                            ...
                            <div className='flex flex-row  w-full space-x-3 mt-8'>
                                ...
                                <button className='flex text-sm text-center items-center bg-transparent rounded-lg border-2 border-[#217346] p-2 text-[#247BAF] px-6 py-2' onClick={addExcludedCompanies}>Add</button>
                            </div>
