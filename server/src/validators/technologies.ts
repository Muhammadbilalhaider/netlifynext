...
export const technologyAddSchema = (req: Request, res: Response, next: NextFunction) => {
...
export const technologyAllSchema = (req: Request, res: Response, next: NextFunction) => {
    const schema = Joi.object({
